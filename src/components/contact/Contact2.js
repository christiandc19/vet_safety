    ...
    <div class="contact-form-content">
      ...
      <div class="left-side">
        ...
        <div class="address details">
          ...
          <div class="text-one">2828 H street #H,</div>
          <div class="text-two">Bakersfield, CA 93301</div>
        </div>

        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div><br/>
          <div class="text-one"><a href="tel:3234035422"> +1 (323) 403-5422</a></div>
        </div>

        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div><br/>
          <div class="text-one"> info@bakersfieldrehab.biz</div>
        </div>
      </div>
